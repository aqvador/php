...
<body>
	<div id="content">
		...
		<div id="footer">
			<p>Copyright &copy; <em>minimalistica</em> &middot; <?php echo $body['year']; ?> Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>